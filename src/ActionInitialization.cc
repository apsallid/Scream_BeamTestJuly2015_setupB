...
//  OutfileManager* out = new OutfileManager();
  // Actions
  SetUserAction(new RunAction(histo));//,out));
}
...
void ActionInitialization::Build() const
{
 ...
 // OutfileManager* out = new OutfileManager();
  ...
  RunAction* runAction = new RunAction(histo);//};, out);  
  SetUserAction(runAction);
  
  EventAction* eventAction = new EventAction(runAction, histo, kin);//, out);
